  ...
  try {
    ...
    return (
      <div className='w-full'>
        ...
        <section className="py-5 mb-4 bg-gradient-to-l from-lime-50 to-slate-200 dark:bg-gray-800 dark:text-gray-100"  >
        ...
        <div>
          ...
          <section className="py-5 mb-3 bg-gradient-to-l from-orange-100 to-slate-200 dark:bg-gray-800 dark:text-gray-100">
